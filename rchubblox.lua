...
--     warn("❌ This script must only be executed from the offical Rchub loader")
--         return
--     end
...
-- _G.__userKey = nil
print("✅ Security verification passed. Loading Rchub...")
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Rchub") then
			makefolder("Rchub");
		end;
		if not isfolder("Rchub/Blox Fruits/") then
			makefolder("Rchub/Blox Fruits/");
		end;
		if not isfile(("Rchub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Rchub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Rchub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("Rchub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("Rchub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
...
MainTab:Button("Copy Discord Link", function()
	setclipboard("https://discord.gg/5vZnv2rrbE");
